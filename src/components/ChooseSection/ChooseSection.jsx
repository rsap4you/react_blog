  ...
  return (
    <div>
      <div className="container">
        <h2 className="text-center mb-5">Why choose RSAP4YOU?</h2>
            ...
            <Card className="d-flex align-items-center border-0 h-100">
              ...
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  RSAP4YOU celebrates a double triumph, clinching two
                  prestigious trophies for innovation and excellence, a
                  testament to the dedication of our family as we continue
                  pushing the boundaries in the evolving world of technology.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
